...
namespace GameStack.JWT
{
    ...
    public interface IJwtDecoder
    {
        ...
        /// <typeparam name="T">The type to return</typeparam>
        /// <param name="jwt">The JWT</param>
        /// <param name="jsonUnmarshaler">A custom JSON unmarshaler.</param>
        /// <returns>An object representing the payload</returns>
        T DecodeToObject<T>(JwtParts jwt, Func<string, T> jsonUnmarshaler);
        ...
        /// <param name="verify">Whether to verify the signature (default is true)</param>
        /// <returns>An object representing the payload</returns>
        T DecodeToObject<T>(JwtParts jwt, byte[] key, bool verify, Func<string, T> jsonUnmarshaler);
        ...
        /// <param name="jsonUnmarshaler">A custom JSON unmarshaler.</param>
        /// <returns>An object representing the payload</returns>
        T DecodeToObject<T>(JwtParts jwt, byte[][] keys, bool verify, Func<string, T> jsonUnmarshaler);
    ...
    public static class JwtDecoderExtensions
    {
        ...
        /// <param name="token">The JWT</param>
        /// <returns>An object representing the payload</returns>
        public static T DecodeToObject<T>(this IJwtDecoder decoder,
            string token, Func<string, T> jsonUnmarshaler) =>
            decoder.DecodeToObject<T>(new JwtParts(token), jsonUnmarshaler);
        ...
        /// <param name="verify">Whether to verify the signature (default is true)</param>
        /// <returns>An object representing the payload</returns>
        public static T DecodeToObject<T>(this IJwtDecoder decoder, string token, byte[][] keys, bool verify, Func<string, T> jsonUnmarshaler) =>
            decoder.DecodeToObject<T>(new JwtParts(token), keys, verify, jsonUnmarshaler);
