...
namespace GameStack.Model.Auth.Input
{
    [Serializable]
    public class LoginPlayerInput
    {
        ...
        {
            return typeof(LoginPlayerInput).FullName + ":: username: " +
    ...
    public class LogoutInput
    {
        ...
        public override string ToString()
        {
            return typeof(LogoutInput).FullName + ":: access_token: " +
    ...
    public class CreateGameStackUserInput
    {
        ...
        public override string ToString()
        {
            return typeof(CreateGameStackUserInput).FullName + ":: username: " +
    ...
    public class RefreshTokenInput
    {
        ...
        public override string ToString()
        {
            return typeof(RefreshTokenInput).FullName + ":: refresh_token: " +
                refresh_token + " session: " + session.ToString();
        }
    }
}
